...
library Utils{
    ...
    /**
    * @notice Converts an undounded byte array to bytes32. Will only load first 32 bytes if parsed array is larger.
    * @param source - to be converted byte array
    * @return bytes32 representation of parsed byte array.
    */
